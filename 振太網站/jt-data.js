...
const ROLLER_FRAMES = '/wp-content/uploads/zhentai/frames_webp/';
const FB = '/wp-content/uploads/zhentai/frames_webp/';
const SERIES_FOLDER = {
...
const JT_DATA = [
  ...
  { no:6, series:'replenishing', zh:'自動上料平台系統', en:'AUTOMATIC FEEDING PLATFORM SYSTEM', vi:'Hệ thống bàn cấp liệu tự động', items:[
    { zh:'模式一 · 全自動上料平台', en:'Mode 1: Fully Automatic Feeding Platform', vi:'Chế độ 1 · Bàn cấp liệu tự động', img:['自動上料平台系統/模式一 A.png','自動上料平台系統/模式一 B.png'] },
    { zh:'模式二 · 全自動雙層交換上料平台', en:'Mode 2: Fully Automatic Dual-Layer Exchange Feeding Platform', vi:'Chế độ 2 · Bàn cấp liệu trao đổi hai tầng', img:['自動上料平台系統/模式二A.png','自動上料平台系統/模式二B.png'] },
    { zh:'模式三 · 全自動雙層雙軌交換上料平台', en:'Mode 3: Fully Automatic Dual-Layer, Dual-Track Exchange Feeding Platform', vi:'Chế độ 3 · Bàn cấp liệu trao đổi hai tầng hai ray', img:[] },
  ]},
  ...
  { no:4, series:'sorting', zh:'羅拉篩選機', en:'ROLLER SORTING MACHINE', vi:'Máy sàng lọc trục lăn', items:[
    { zh:'羅拉篩選機 (兩軸)', en:'Two-Axis Roller Sorting Machine', vi:'Máy sàng lọc trục lăn (2 trục)', img:['羅拉篩選機/羅拉篩選機(兩軸).png'], frames:ROLLER_FRAMES },
